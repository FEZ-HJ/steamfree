...
//    }
    ...
    public void configure(WebSecurity web){
        ...
        web.ignoring().antMatchers("/login","/wxLogin","/homepage","/code/image","/freeGame/findAll"
                ,"/freeGame/findById","/lottery/**","/push/insert","/gift/**","/prize/**","/cgi","/ghz","/miniProgram","/s","/signIn/**","/user/**");
    }
}
